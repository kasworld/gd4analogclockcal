...
var colors_light = 	{
	...
	dial_360_1 = [Color.ORANGE_RED, Color.ORANGE],
	dial_360_2 = [Color.DARK_BLUE, Color.BLUE],
	dial_90_1 = [Color.ORANGE_RED, Color.ORANGE],
	dial_90_2 = [Color.DARK_BLUE, Color.BLUE],
	dial_30 = [Color.ORANGE_RED, Color.ORANGE],
	dial_6 = [Color.ORANGE_RED, Color.ORANGE],
	dial_1 = [Color.ORANGE_RED, Color.ORANGE],
}
